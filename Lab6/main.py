...
with open('teska_dogs.txt', 'r') as reader:
    print(reader.read())
...
# Zapisywanie poprzedniego pliku
with open('teska_dogs_reversed.txt', 'w') as writer:
    # Zapisywanie piesków w odwrotnej kolejności
    for breed in reversed(dog_breeds):
        writer.write(breed)

# Czytanie bajtów ze zdjęcie linijka po linijce
with open('teska_jack_russell.png', 'rb') as byte_reader:
...
with open('teska_dogs.txt', 'a') as a_writer:
    a_writer.write('\nBeagle')
