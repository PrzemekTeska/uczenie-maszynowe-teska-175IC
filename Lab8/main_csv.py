...
# Czytanie pliku CSV
with open('csv/employee_birthday.txt') as csv_file:
...
# Czytanie pliku CSV do słownika
...
# Zapisywanie pliku CSV ze słownika
with open('csv/employee_file2.csv', mode='w') as csv_file:
...
# Parsowanie skomplikowanych plików CSV z pomocą pandas
df = pandas.read_csv('csv/hrdata.csv', index_col='Name', parse_dates=['Hire Date'])
print(df)
print(type(df['Hire Date'][0]))

# Zapisywanie plików CSV z pomocą pandas
