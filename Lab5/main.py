...
# Rozkładanie zdań na czynniki pierwsze
piano_text = 'Przemek uczy się grać na keyboardzie.'
piano_doc = nlp(piano_text)
for token in piano_doc:
    print(token.text, token.tag_, token.head.text, token.dep_)

# Drzewo - zawiera informacje o strukturze i gramatyce zdania
one_line_about_text = ('Gus Proto to developer Pythona'
                       ' obecnie pracującym dla firmy Fintech znajdującej się w Londynie')
...
# Shallow-parsing - wyciąganie zwrotów z tekstu
conference_text = ('Konferencja dla developerów'
                   ' odbędzie się dnia 21 lipca 2019 w Londynie.')
conference_doc = nlp(conference_text)
# Extract Noun Phrases
for chunk in conference_doc.noun_chunks:
    print(chunk)

# NER - znajdywanie nazw własnych
